          ...
          <div className="rounded-[1.5rem] border border-white/10 bg-white/5 p-3 backdrop-blur-xl">
            ...
            <div className="mt-3 border-t border-white/10 pt-3">
              ...
              <div className="grid grid-cols-3 gap-1 mb-2">
                {(['light', 'morandi', 'dark'] as const).map((mode) => (
                  <button
                    key={mode}
                    type="button"
                  ...
                  >
                    <p className="text-[9px] font-bold text-[#fff4e5]">{mode === 'light' ? '☀ 淺底' : mode === 'morandi' ? '◆ 莫蘭迪' : '● 深底'}</p>
                  </button>
                ))}
              </div>
              {/* 強調色 */}
                    ...
                    {currentPageNotes.map((note, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex min-w-0 flex-1 flex-col px-2 pt-0.5 pb-0.5">
                            {/* 上半：酒名/酒造 + 右側 stats */}
