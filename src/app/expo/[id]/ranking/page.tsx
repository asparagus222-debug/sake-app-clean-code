            ...
            <div className="mt-3 border-t border-white/10 pt-3">
              ...
              <div className="grid grid-cols-3 gap-1 mb-2">
                {(['light', 'vivid', 'dark'] as const).map((mode) => (
                  ...
                  >
                    <p className="text-[9px] font-bold text-[#fff4e5]">{mode === 'light' ? '☀ 淺底' : mode === 'vivid' ? '◆ 鮮艷' : '● 深底'}</p>
                  </button>
                ))}
              </div>
              {/* 強調色 */}
                ...
                <div className={cn('flex h-full flex-col rounded-[1.2rem] border px-2 py-2', currentShareCardTheme.frameClassName)}>
                  ...
                  <div className="mt-1 flex min-h-0 flex-1 flex-col gap-[3px] overflow-hidden">
                    {currentPageNotes.map((note, i) => {
                      ...
                      const medalStyle = getRankMedalStyle(rank, cardMode !== 'light', currentShareCardTheme.rowBaseClassName);
                      return (
                        <div
                          key={note.id}
