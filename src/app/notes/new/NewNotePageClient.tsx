      ...
      <div className="space-y-5" style={{ opacity: canCreateNote ? 1 : 0.5, pointerEvents: canCreateNote ? 'auto' : 'none' }}>
        ...
        <section className="space-y-4 dark-glass p-5 rounded-xl border border-primary/20 shadow-xl">
          ...
          <div className="grid grid-cols-2 items-center gap-6">
            ...
            <div className="flex flex-col items-center justify-center"><SakeRadarChart data={{ sweetness: formData.sweetness, acidity: formData.acidity, bitterness: formData.bitterness, umami: formData.umami, astringency: formData.astringency }} /></div>
          </div>
        </section>
