...
export const SAKE_DATABASE: SakeDatabaseEntry[] = [
  ...
  // --- SAKETIME 排名擴充 (2026-04 第 10-19 頁) ---
  { brand: "人気一", brewery: "人気酒造", location: "福島縣" },
  { brand: "今西", brewery: "今西酒造", location: "奈良縣" },
  { brand: "溪", brewery: "王祿酒造", location: "島根縣" },
  { brand: "本洲一", brewery: "梅田酒造場", location: "廣島縣" },
  { brand: "あさ開", brewery: "あさ開", location: "岩手縣" },
  { brand: "江戸開城", brewery: "東京港醸造", location: "東京都" },
  { brand: "神開", brewery: "藤本酒造", location: "滋賀縣" },
  { brand: "恵那山", brewery: "はざま酒造", location: "岐阜縣" },
  { brand: "龍水泉", brewery: "市野屋商店", location: "長野縣" },
  { brand: "十旭日", brewery: "旭日酒造", location: "島根縣" },
  { brand: "美富久", brewery: "美冨久酒造", location: "滋賀縣" },
  { brand: "琥泉", brewery: "泉酒造", location: "兵庫縣" },
  { brand: "誉池月", brewery: "池月酒造", location: "島根縣" },
  { brand: "常きげん", brewery: "鹿野酒造", location: "石川縣" },
  { brand: "香露", brewery: "熊本県酒造研究所", location: "熊本縣" },
  { brand: "喜多屋", brewery: "喜多屋", location: "福岡縣" },
  { brand: "純青", brewery: "富久錦", location: "兵庫縣" },
  { brand: "Unfeigned SAKE", brewery: "梅乃宿酒造", location: "奈良縣" },
  { brand: "二世古", brewery: "二世古酒造", location: "北海道" },
  { brand: "ほしいずみ", brewery: "丸一酒造", location: "愛知縣" },
  { brand: "十八盛", brewery: "十八盛酒造", location: "岡山縣" },
  { brand: "桃の里", brewery: "赤磐酒造", location: "岡山縣" },
  { brand: "木戸泉", brewery: "木戸泉酒造", location: "千葉縣" },
  { brand: "唯々", brewery: "竹内酒造", location: "滋賀縣" },
  { brand: "金亀", brewery: "岡村本家", location: "滋賀縣" },
  { brand: "積善", brewery: "西飯田酒造店", location: "長野縣" },
  { brand: "朝日栄", brewery: "相良酒造", location: "栃木縣" },
  { brand: "ヤマサン正宗", brewery: "酒持田本店", location: "島根縣" },
  { brand: "KURAMOTO", brewery: "倉本酒造", location: "奈良縣" },
  { brand: "ROOM", brewery: "八千代酒造", location: "山口縣" },
  { brand: "上善如水", brewery: "白瀧酒造", location: "新潟縣" },
  { brand: "醉心", brewery: "酔心山根本店", location: "廣島縣" },
  { brand: "白岳仙", brewery: "安本酒造", location: "福井縣" },
  { brand: "国稀", brewery: "国稀酒造", location: "北海道" },
  { brand: "諏訪泉", brewery: "諏訪酒造", location: "鳥取縣" },
  { brand: "城陽", brewery: "城陽酒造", location: "京都府" },
  { brand: "櫻正宗", brewery: "櫻正宗", location: "兵庫縣" },
  { brand: "茜さす", brewery: "土屋酒造店", location: "長野縣" },
  { brand: "如空", brewery: "八戸酒類 五戸工場", location: "青森縣" },
  { brand: "小鼓", brewery: "西山酒造場", location: "兵庫縣" },
  { brand: "古伊万里", brewery: "古伊万里酒造", location: "佐賀縣" },
  { brand: "山猿", brewery: "永山酒造", location: "山口縣" },
  { brand: "寒北斗", brewery: "寒北斗酒造", location: "福岡縣" },
  { brand: "土佐鶴", brewery: "土佐鶴酒造", location: "高知縣" },
  { brand: "笹一", brewery: "笹一酒造", location: "山梨縣" },
  { brand: "戦勝政宗", brewery: "仙台伊澤家 勝山酒造", location: "宮城縣" },
  { brand: "金鼓", brewery: "大倉本家", location: "奈良縣" },
  { brand: "東力士", brewery: "島崎酒造", location: "栃木縣" },
  { brand: "竹鶴", brewery: "竹鶴酒造", location: "廣島縣" },
  { brand: "杣の天狗", brewery: "上原酒造", location: "滋賀縣" },
  { brand: "雪中梅", brewery: "丸山酒造場", location: "新潟縣" },
  { brand: "幸姫", brewery: "幸姫酒造", location: "佐賀縣" },
  { brand: "雪月花", brewery: "両関酒造", location: "秋田縣" },
  { brand: "灘菊", brewery: "灘菊酒造", location: "兵庫縣" },
  { brand: "日輪田", brewery: "萩野酒造", location: "宮城縣" },
  { brand: "蒼天伝", brewery: "男山本店", location: "宮城縣" },
  { brand: "太平山", brewery: "小玉醸造", location: "秋田縣" },
  { brand: "神聖", brewery: "山本本家", location: "京都府" },
  { brand: "朝日山", brewery: "朝日酒造", location: "新潟縣" },
  { brand: "太平海", brewery: "府中誉", location: "茨城縣" },
  { brand: "天山", brewery: "天山酒造", location: "佐賀縣" },
  { brand: "綾菊", brewery: "綾菊酒造", location: "香川縣" },
  { brand: "颯", brewery: "後藤酒造場", location: "三重縣" },
  { brand: "川亀", brewery: "川亀酒造", location: "愛媛縣" },
  { brand: "笹祝", brewery: "笹祝酒造", location: "新潟縣" },
  { brand: "美和桜", brewery: "美和桜酒造", location: "廣島縣" },
  { brand: "空蔵", brewery: "浜福鶴銘醸", location: "兵庫縣" },
  { brand: "松竹梅", brewery: "宝酒造", location: "京都府" },
  { brand: "丹沢山", brewery: "川西屋酒造店", location: "神奈川縣" },
  { brand: "超久", brewery: "中野ＢＣ", location: "和歌山縣" },
  { brand: "惣邑", brewery: "長沼合名", location: "山形縣" },
  { brand: "れいざん", brewery: "山村酒造", location: "熊本縣" },
  { brand: "琵琶のさゝ浪", brewery: "麻原酒造", location: "埼玉縣" },
  { brand: "五人娘", brewery: "寺田本家", location: "千葉縣" },
  { brand: "賀茂泉", brewery: "賀茂泉酒造", location: "廣島縣" },
  { brand: "HINEMOS", brewery: "森山酒造場", location: "神奈川縣" },
  { brand: "盛升", brewery: "黄金井酒造", location: "神奈川縣" },
  { brand: "霧降", brewery: "せんきん", location: "栃木縣" },
  { brand: "百光", brewery: "楯の川酒造", location: "山形縣" },
  { brand: "ど辛", brewery: "山本合名会社", location: "秋田縣" },
  { brand: "初緑", brewery: "奥飛騨酒造", location: "岐阜縣" },
  { brand: "天鷹", brewery: "天鷹酒造", location: "栃木縣" },
  { brand: "てふ", brewery: "国権酒造", location: "福島縣" },
  { brand: "旭菊", brewery: "旭菊酒造", location: "福岡縣" },
  { brand: "鳳鳴", brewery: "鳳鳴酒造", location: "兵庫縣" },
  { brand: "杜の蔵", brewery: "杜の蔵", location: "福岡縣" },
  { brand: "澤姫", brewery: "井上清吉商店", location: "栃木縣" },
  { brand: "雪の松島", brewery: "大和蔵酒造", location: "宮城縣" },
  { brand: "菊の司", brewery: "菊の司酒造", location: "岩手縣" },
  { brand: "千歳", brewery: "山名酒造", location: "兵庫縣" },
  { brand: "AGEO", brewery: "北西酒造株式会社", location: "埼玉縣" },
  { brand: "浜千鳥", brewery: "浜千鳥", location: "岩手縣" },
  { brand: "睡龍", brewery: "久保本家酒造", location: "奈良縣" },
  ...
  { brand: "神泉", brewery: "東酒造", location: "石川縣" },
  { brand: "竹生嶋", brewery: "吉田酒造", location: "滋賀縣" },
  { brand: "九曜正宗", brewery: "熊本県酒造研究所", location: "熊本縣" },
  { brand: "隆", brewery: "川西屋酒造店", location: "神奈川縣" },
  { brand: "有磯曙", brewery: "高澤酒造場", location: "富山縣" },
  { brand: "四季桜", brewery: "宇都宮酒造", location: "栃木縣" },
  { brand: "雄東正宗", brewery: "杉田酒造", location: "栃木縣" },
  { brand: "八鹿", brewery: "八鹿酒造", location: "大分縣" },
  { brand: "金婚", brewery: "豊島屋酒造", location: "東京都" },
  { brand: "稲村屋", brewery: "鳴海醸造店", location: "青森縣" },
  { brand: "菊泉", brewery: "滝澤酒造", location: "埼玉縣" },
  { brand: "桃川", brewery: "桃川", location: "青森縣" },
  { brand: "国士無双", brewery: "高砂酒造", location: "北海道" },
  { brand: "宗政", brewery: "宗政酒造", location: "佐賀縣" },
  { brand: "喜平", brewery: "平喜酒造", location: "岡山縣" },
